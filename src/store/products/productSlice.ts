...
const initialState: ProductState = {
  ...
  \nБлагодаря своей форме и размеру, она станет идеальным выбором для утреннего кофе или вечернего чая, и принесет вам массу приятных эмоций каждый день!`,
    ...
    },
    {
      ...
      name: 'Кубок Силы: Отважься на победу',
      description:
        'Смело иди к своей победе, уверенный в своей силе, с кубком Силы в руках!',
      price: 2100,
      oldPrice: 3400,
    },
    {
      ...
      name: 'Браслет Духов: Соединение с природой',
      description:
        'Этот унисекс браслет вдохновлен древней культурой друидов и символизирует силу и связь с природой. Браслет изготовлен из натуральных материалов и украшен символами, которые напоминают о смелости и духовной силе. Носите браслет Духов, чтобы поддерживать свою силу и баланс с природой в повседневной жизни.',
      price: 10999,
      oldPrice: 11099,
    },
  ],
